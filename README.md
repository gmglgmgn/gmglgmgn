...
- [HIARC](https://hiarchomepage.web.app/) 일반 멤버 (2025.03 ~ now)
    - HIARC 알고리즘 기초 스터디 참여 (2025 Spring) 

#### 프로젝트
- 컴퓨터그래픽과 메타버스 기말 프로젝트 (https://github.com/orgs/2025-Metamong/repositories)

#### BOJ 페이지
- (https://www.acmicpc.net/user/gmglgmgn)